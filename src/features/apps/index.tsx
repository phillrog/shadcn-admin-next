  ...
  return (
    <>
      ...
      <Main fixed>
          ...
          <div className='flex flex-col gap-4 sm:my-4 sm:flex-row'>
            ...
            <Select value={type} onValueChange={handleTypeChange}>
              <SelectTrigger className='w-36'>
                <SelectValue>{appText.get(type)}</SelectValue>
              </SelectTrigger>
              <SelectContent>
        ...
        <ul className={`faded-bottom no-scrollbar grid gap-4 overflow-auto pt-4 pb-16 md:grid-cols-2 lg:grid-cols-3 ${isPending ? 'opacity-50' : ''}`}>
